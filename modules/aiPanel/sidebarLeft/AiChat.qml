    ...
    property var allCommands: [
        ...
        },
        {
            ...
            execute: () => {
                Ai.addMessage(`
<think>
Hmmmm.... Omarchy it is huh? Pretty cool!
</think>
## ✏️ Omarchy AI Panel 

### Formatting

- *Italic*, \`Monospace\`, **Bold**, [Omarchy](https://omarchy.org/)
...
|                          | Omarchy           | Others                     |
|--------------------------|-------------------|----------------------------|
| UI Toolkit               | Hyprland + Qt     | Whatever you cobble        |
| Window Manager           | Hyprland          | Pick your poison           |
| Commands                 | omarchy * (145)   | Scattered scripts          |
| Theme Switching          | omarchy theme set | Manual chaos             |
| Keybindings              | bindings.conf     | Guess & pray               |
...
`, Ai.interfaceRole);
    ...
    function handleInput(inputText) {
        if (inputText.trim().toLowerCase() === "/quattro") {
        ...
        FlowButtonGroup { // Suggestions
            ...
            Repeater {
                ...
                delegate: ApiCommandButton {
                    ...
                    colBackgroundActive: colBackground
                    bounce: false
